...
all_numbers = [2018382463]

for num in all_numbers:
    client.messages.create(to=num,from_=twilio_number,body="Smokey Bears has identified a fire nearby! Where are you?")
    # client.messages.create(to=num,from_=twilio_number,body="Please send us pictures of anything dangerous")
